...
public class AuthService implements IAuthService{
    ...
    @Override
    public AuthResponseInternalEvent login(String userName, String plainPassword) throws AuthenticationException {
        //Search by UserName
        ...
        if (checkPassword(plainPassword, storedHash)) {
            ...
            // Return the user information if this is logged correctly
            return new AuthResponseInternalEvent(token, user.getUserName(), "Bearer ", user.getRole());
        } else {
